...
/**
 * Jersey REST client generated for REST resource:SupplierFacadeREST
 * [tupt.entities.supplier]<br>
 * USAGE:
 * <pre>
...
public class SupplierClient {
    ...
    public SupplierClient() {
        ...
        webTarget = client.target(BASE_URI).path("tupt.entities.supplier");
    }
...
//    public <T> T insert(Class<T> responseType) throws ClientErrorException {
//        WebTarget resource = webTarget;
//        resource = resource.path("insert");
//        return resource.get(responseType);
//    }

    public <T> T createSupplier_XML(Object requestEntity, Class<T> responseType) throws ClientErrorException {
