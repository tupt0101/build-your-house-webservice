...
public class SupplierFacadeREST extends AbstractFacade<Supplier> {
    ...
    public Supplier findByName(@QueryParam("name") String name) {
        try {
            TypedQuery query = em.createNamedQuery("Supplier.findByName", Supplier.class);
